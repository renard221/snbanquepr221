...
<div class="container">
    ...
    <?php if ($compte == null):  ?>
<p style="font-size: 50px;"> Bonjour <?=$nom ?>, veuillez creer votre compte <a href="creationCompte.php">ici </a>  </p>
    <?php endif;  ?>
    <?php if ($compte != null):  ?>
<div class="row" style="font-size: 30px;">
    <div class="col-md-4"  >C. Numero: <?=$compte["numero"] ?></div>
    <div class="col-md-4">Type: <?=$compte["type"] ?></div>
    <div class="col-md-4">Solde: <?=$compte["solde"] ?> FCFA</div>
</div>
<br>
